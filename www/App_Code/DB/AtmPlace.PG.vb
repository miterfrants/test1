Namespace DB
    Partial Public Class AtmPlace
        ...
        '** 2013/12/8 下午 04:24:57, Set NullWithDefault to False to get exception when the field is null **
        ...
        Overrides ReadOnly Property htTypeDefinesForRecord() As Hashtable
            Get
                Return DB.AtmPlace.htTypeDefines
            End Get
        End Property

        Public Const BaseTableName_Const As String = "atm_place"
        ...
        Public Const FullTableName_Const As String = "atm_place"
