Namespace DB
    Partial Public Class GasStationPlace
        ...
        '** 2013/12/10 下午 05:17:59, Set NullWithDefault to False to get exception when the field is null **
        ...
        Overrides ReadOnly Property htTypeDefinesForRecord() As Hashtable
            Get
                Return DB.GasStationPlace.htTypeDefines
            End Get
        End Property

        Public Const BaseTableName_Const As String = "gas_station_place"

        Public Overrides ReadOnly Property BaseTableName() As String
            Get
                Return "gas_station_place"
            End Get
        End Property

        Public Const FullTableName_Const As String = "gas_station_place"
