Namespace DB
    Partial Public Class MobileReportCategoryClick
        ...
        '** 2013/11/25 下午 11:30:55, Set NullWithDefault to False to get exception when the field is null **
        ...
        Overrides ReadOnly Property htTypeDefinesForRecord() As Hashtable
            Get
                Return DB.MobileReportCategoryClick.htTypeDefines
            End Get
        End Property

        Public Const BaseTableName_Const As String = "mobile_report_category_click"

        Public Overrides ReadOnly Property BaseTableName() As String
            Get
                Return "mobile_report_category_click"
            End Get
        End Property

        Public Const FullTableName_Const As String = "mobile_report_category_click"
