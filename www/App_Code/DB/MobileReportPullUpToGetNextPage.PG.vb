Namespace DB
    Partial Public Class MobileReportPullUpToGetNextPage
        ...
        '** 2013/11/26 下午 08:34:05, Set NullWithDefault to False to get exception when the field is null **
        ...
        Overrides ReadOnly Property htTypeDefinesForRecord() As Hashtable
            Get
                Return DB.MobileReportPullUpToGetNextPage.htTypeDefines
            End Get
        End Property

        Public Const BaseTableName_Const As String = "mobile_report_pull_up_to_get_next_page"

        Public Overrides ReadOnly Property BaseTableName() As String
            Get
                Return "mobile_report_pull_up_to_get_next_page"
            End Get
        End Property

        Public Const FullTableName_Const As String = "mobile_report_pull_up_to_get_next_page"
