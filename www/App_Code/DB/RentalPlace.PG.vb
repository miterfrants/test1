Namespace DB
    Partial Public Class RentalPlace
        ...
        '** 2013/12/17 下午 04:53:51, Set NullWithDefault to False to get exception when the field is null **
        ...
        Overrides ReadOnly Property htTypeDefinesForRecord() As Hashtable
            Get
                Return DB.RentalPlace.htTypeDefines
            End Get
        End Property

        Public Const BaseTableName_Const As String = "rental_place"
        ...
        Public Const FullTableName_Const As String = "rental_place"
