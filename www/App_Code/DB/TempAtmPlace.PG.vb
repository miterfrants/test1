Namespace DB
    Partial Public Class TempAtmPlace
        ...
        '** 2013/12/8 下午 04:02:33, Set NullWithDefault to False to get exception when the field is null **
        ...
        Overrides ReadOnly Property htTypeDefinesForRecord() As Hashtable
            Get
                Return DB.TempAtmPlace.htTypeDefines
            End Get
        End Property

        Public Const BaseTableName_Const As String = "temp_atm_place"

        Public Overrides ReadOnly Property BaseTableName() As String
            Get
                Return "temp_atm_place"
            End Get
        End Property

        Public Const FullTableName_Const As String = "temp_atm_place"
