Namespace DB
    Partial Public Class TempRentalPlace
        ...
        '** 2013/12/17 下午 04:43:42, Set NullWithDefault to False to get exception when the field is null **
        ...
        Overrides ReadOnly Property htTypeDefinesForRecord() As Hashtable
            Get
                Return DB.TempRentalPlace.htTypeDefines
            End Get
        End Property

        Public Const BaseTableName_Const As String = "temp_rental_place"

        Public Overrides ReadOnly Property BaseTableName() As String
            Get
                Return "temp_rental_place"
            End Get
        End Property

        Public Const FullTableName_Const As String = "temp_rental_place"
